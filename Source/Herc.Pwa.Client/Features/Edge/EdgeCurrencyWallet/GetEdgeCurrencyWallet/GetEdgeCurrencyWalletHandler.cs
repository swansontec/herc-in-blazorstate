...
namespace Herc.Pwa.Client.Features.Edge.EdgeCurrencyWallet.GetEdgeCurrencyWallet
{
  ...
  public class GetEdgeCurrencyWalletHandler : BaseHandler<GetEdgeCurrencyWalletAction, EdgeCurrencyWalletState>
  {
    ...
    public override async Task<EdgeCurrencyWalletState> Handle(GetEdgeCurrencyWalletAction request, CancellationToken aCancellationToken)
    {
